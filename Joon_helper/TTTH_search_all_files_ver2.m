function [filelist_st, relative_path] = TTTH_search_all_files_ver2(dirName, check_sub_dir, str_pattern, relative_prefix)
...
for i=1:length(filelist_st)
    relative_path{i,1} = [relative_prefix filelist_st{i}(len+2:end)];
end
end
