function [filelist_st, relative_path] = TTTH_search_all_files_ver3(dirName, check_sub_dir, str_pattern, relative_prefix)
% Example: filelist = TTTH_get_all_files('D:\root\sub_root', 0, 'JL_su_*.mat', '\sub_root\');
...
for i=1:length(filelist_st)
    relative_path{i,1} = [relative_prefix filelist_st{i}(len+1:end)];
end
end
