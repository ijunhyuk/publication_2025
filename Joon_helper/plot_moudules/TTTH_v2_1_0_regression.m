function [corr_val, p_val, reg_x, reg_y]= TTTH_v2_1_0_regression(axes_cur, dat, ...
...
%%
    ...
    if is_plot_scatter
        scatter(dat(:,1),dat(:,2),'o', 'MarkerEdgeColor', dot_color,'LineWidth',0.5);
    end
    if is_plot_regression
        plot(reg_x,reg_y,'-', 'color',dot_color);               % plot regression line
    end
end