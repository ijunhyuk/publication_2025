function TTT_eyeb100_5_3_plot_eyeB_st(eyeB_st, ax1, plot_type)
% manual parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif plot_type==2 || plot_type==3 %different colors for different 1-110 trials.
    %cla;
    
    if plot_type==2 %plot cs only
        ...
        %20231006 blue: early trials, red: late trials
        for i=1:n
            plot(ax1,xx,eye_h_cs_only(:,i),'color',col_arr(i,:)); hold on;
        end
    elseif plot_type==3 %plot cs-us
